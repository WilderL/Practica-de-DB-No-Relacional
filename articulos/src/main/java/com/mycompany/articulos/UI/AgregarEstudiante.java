...
public class AgregarEstudiante extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        comentarios_field = new javax.swing.JTextField();
        ...
        jLabel4.setText("No. Articulos");

        jLabel5.setFont(new java.awt.Font("Segoe UI", 0, 24)); // NOI18N
        jLabel5.setText("No.Comentarios");
            ...
            .addGroup(layout.createSequentialGroup()
                ...
                .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    ...
                    .addGroup(layout.createSequentialGroup()
                        ...
                        .addGap(41, 41, 41)
                        .addComponent(comentarios_field))
                    .addGroup(layout.createSequentialGroup()
    ...
    private void save_buttonActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_save_buttonActionPerformed
        ...
        String comentarios = comentarios_field.getText();
        String user = user_field.getText();
        String pass = pass_field.getText();
        doc.append("nombre",nombre)
                .append("apellido", apellido).append("NoArticulos", articulos)
                .append("NoComentarios", comentarios).append("user", user).append("pass",pass);
        
        conexion.insertarEstudiante(doc);
        this.dispose();
    ...
    private javax.swing.JTextField comentarios_field;
